...
export default function Home(){
    ...
    const removeitem = async (product_id) => {
        ...
        try {
          await axios.get(`https://ecommerce.ahmedgamaldev.com/api/cart/destroy/${product_id}`, {
            headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
              'Authorization': `Bearer ${localStorage.getItem("token_app")}`
    ...
    const incrementItem = async (product_id) => {
        try {
          await axios.get(`https://ecommerce.ahmedgamaldev.com/api/cart/increment/${product_id}`, {
            headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
              'Authorization': `Bearer ${localStorage.getItem("token_app")}`
    ...
    const decrementItem = async (product_id) => {
        console.log("Clicked remove for product:", product_id);
        try {
          await axios.get(`https://ecommerce.ahmedgamaldev.com/api/cart/decrement/${product_id}`, {
            headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
              'Authorization': `Bearer ${localStorage.getItem("token_app")}`
